export default function page(){ 
  return  <div className="flex justify-center items-center h-screen bg-gray-200 px-6 ">
            <div className="p-6 max-w-sm w-full bg-white shadow-md rounded-md">
                ...
                <form className="mt-4" action="/" method="GET">
                    <label className="block">
                        ...
                        <input type="email" className="form-input mt-1 block w-full rounded-md focus:border-indigo-600" />
                    </label>

                    <label className="block mt-3">
                        <span className="text-gray-700 text-sm">Password</span>
                        <input type="password" className="form-input mt-1 block w-full rounded-md focus:border-indigo-600"/>
                    </label>
